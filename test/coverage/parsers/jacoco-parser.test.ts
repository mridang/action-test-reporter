...
import { JacocoParser } from '../../../src/coverage/parsers/jacoco/jacoco-parser.js';
...
describe('jacoco parser', () => {
  test('parses jacoco xml content', async () => {
    ...
    const outputPath = path.join(outputDir, 'jacoco.md');
